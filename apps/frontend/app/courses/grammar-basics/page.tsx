...
const lessons = [
    { id: 1, title: "Les articles (a, an, the)", duration: "15 min", completed: false, locked: false },
    { id: 2, title: "Les pronoms personnels", duration: "20 min", completed: false, locked: false },
    { id: 3, title: "Le verbe 'to be'", duration: "25 min", completed: false, locked: false },
    { id: 4, title: "Le présent simple", duration: "30 min", completed: false, locked: true },
    { id: 5, title: "Les adjectifs possessifs", duration: "20 min", completed: false, locked: true },
    { id: 6, title: "Le pluriel des noms", duration: "15 min", completed: false, locked: true },
    { id: 7, title: "There is / There are", duration: "20 min", completed: false, locked: true },
    { id: 8, title: "Les prépositions de lieu", duration: "25 min", completed: false, locked: true },
    { id: 9, title: "Les questions simples", duration: "30 min", completed: false, locked: true },
    { id: 10, title: "La négation", duration: "20 min", completed: false, locked: true },
    { id: 11, title: "Les adverbes de fréquence", duration: "15 min", completed: false, locked: true },
    { id: 12, title: "Quiz final", duration: "30 min", completed: false, locked: true },
];
...
export default function GrammarBasicsPage() {
    return (
            ...
            <div className="container">
                ...
                <div className="course-header">
                    ...
                    <div className="course-info">
                        ...
                        <h1>Les bases de la grammaire</h1>
                        <p>Apprenez les fondamentaux : articles, pronoms, temps simples et structures de base</p>
                        <div className="course-meta">
                            <span><Clock size={16} />4 heures</span>
                            <span><Users size={16} />2 450 étudiants</span>
                ...
                <div className="course-content">
                    <div className="lessons-section">
                        ...
                        <p className="lessons-count">{lessons.length} leçons • 4h de contenu</p>
                            ...
                            {lessons.map((lesson, i) => (
                                <div key={lesson.id} className={`lesson-item ${lesson.locked ? 'locked' : ''}`}>
                                    ...
                                    <div className="lesson-action">
                                        {lesson.locked ? <Lock size={18} /> : <PlayCircle size={24} />}
                                    </div>
                                </div>
                            ))}
                        </div>
                    ...
                    <div className="sidebar">
                        ...
                        <div className="features-card">
                            ...
                            <ul>
                                <li><CheckCircle size={16} />12 leçons interactives</li>
                                <li><CheckCircle size={16} />Exercices pratiques</li>
                                <li><CheckCircle size={16} />Quiz de validation</li>
                                <li><CheckCircle size={16} />Certificat de complétion</li>
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        .lesson-item:hover:not(.locked){transform:translateX(4px);box-shadow:var(--shadow-md)}
